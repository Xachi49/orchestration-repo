...
export const EXAMPLE_CAPABILITIES: readonly Capability[] = [
  ...
  {
    capabilityId: "SEND_RECOVERY_SMS",
    version: "1.0.0",
    description: "Send bounded fake recovery SMS via Revenue Recovery product actuator",
    allowedActions: ["SEND_RECOVERY_SMS"],
    forbiddenActions: ["EXECUTE_SHELL", "RUN_ARBITRARY_COMMAND"],
    allowedEnvironments: ["local", "development"],
    approvalRequirement: "REQUIRED",
    maximumRuntimeSeconds: 30,
    enabled: true,
  ...
  {
    capabilityId: "SEND_RECOVERY_EMAIL",
    version: "1.0.0",
    description: "Send bounded fake recovery email via Revenue Recovery product actuator",
    allowedActions: ["SEND_RECOVERY_EMAIL"],
    forbiddenActions: ["EXECUTE_SHELL", "RUN_ARBITRARY_COMMAND"],
    allowedEnvironments: ["local", "development"],
    approvalRequirement: "REQUIRED",
    maximumRuntimeSeconds: 30,
  ...
  {
    capabilityId: "CREATE_CALLBACK_TASK",
    version: "1.0.0",
    description: "Create bounded recovery callback task via Revenue Recovery product actuator",
    allowedActions: ["CREATE_CALLBACK_TASK"],
    forbiddenActions: ["EXECUTE_SHELL", "RUN_ARBITRARY_COMMAND"],
    allowedEnvironments: ["local", "development"],
    approvalRequirement: "REQUIRED",
    maximumRuntimeSeconds: 30,
